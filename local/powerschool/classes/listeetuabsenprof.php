<?php
   ...
   if ($_POST["cycle"] && $_POST["specialite"]) {
    ...
    WHERE u.id=sbet.idetudiant AND c.id=sbet.idcourses AND a.id=sbet.idanneescolaire AND sbet.idspecialite='".$_POST["specialite"]."' AND 
    AND sbet.idcycle='".$_POST["cycle"]."' AND cs.idcourses=c.id AND cs.id=css.idcoursspecialite AND css.idsemestre='".$_POST["semestre"]."' 
    AND c.id='".$_POST["cours"]."'";
