...
$sqllu = "SELECT fullname,DATE_FORMAT(FROM_UNIXTIME(p.datecours),'%D %b %Y') as datec,heuredebutcours,heurefincours,numerosalle,MONTH(FROM_UNIXTIME(p.datecours)) AS mois,DAYOFWEEK(FROM_UNIXTIME(p.datecours)) AS dayc  FROM {course} c, {specialite} sp,{cycle} cy,{salle} sa, {programme} p,{inscription} i
WHERE p.idcourses = c.id  AND p.idspecialite = sp.id AND i.idetudiant='".$USER->id."'
...
$sqlma = "SELECT fullname,DATE_FORMAT(FROM_UNIXTIME(p.datecours),'%D %b %Y') as datec,heuredebutcours,heurefincours,numerosalle,MONTH(FROM_UNIXTIME(p.datecours)) AS mois,DAYOFWEEK(FROM_UNIXTIME(p.datecours)) AS dayc  FROM {course} c, {specialite} sp,{cycle} cy,{salle} sa, {programme} p,{inscription} i
WHERE p.idcourses = c.id AND p.idspecialite = sp.id AND i.idetudiant='".$USER->id."'
AND p.idcycle = cy.id AND i.idcycle=cy.id AND i.idspecialite=sp.id 
...
$sqlme = "SELECT fullname,DATE_FORMAT(FROM_UNIXTIME(p.datecours),'%D %b %Y') as datec,heuredebutcours,heurefincours,numerosalle,MONTH(FROM_UNIXTIME(p.datecours)) AS mois,DAYOFWEEK(FROM_UNIXTIME(p.datecours)) AS dayc  FROM {course} c, {specialite} sp,{cycle} cy,{salle} sa, {programme} p,{inscription} i
WHERE p.idcourses = c.id AND p.idspecialite = sp.id AND i.idetudiant='".$USER->id."'
AND p.idcycle = cy.id AND i.idcycle=cy.id AND i.idspecialite=sp.id 
...
$sqljeu = "SELECT fullname,DATE_FORMAT(FROM_UNIXTIME(p.datecours),'%D %b %Y') as datec,heuredebutcours,heurefincours,numerosalle,MONTH(FROM_UNIXTIME(p.datecours)) AS mois,DAYOFWEEK(FROM_UNIXTIME(p.datecours)) AS dayc  FROM {course} c, {specialite} sp,{cycle} cy,{salle} sa, {programme} p,{inscription} i
WHERE p.idcourses = c.id AND p.idspecialite = sp.id AND i.idetudiant='".$USER->id."'
AND p.idcycle = cy.id AND i.idcycle=cy.id AND i.idspecialite=sp.id 
...
$sqlven = "SELECT fullname,DATE_FORMAT(FROM_UNIXTIME(p.datecours),'%D %b %Y') as datec,heuredebutcours,heurefincours,numerosalle,MONTH(FROM_UNIXTIME(p.datecours)) AS mois,DAYOFWEEK(FROM_UNIXTIME(p.datecours)) AS dayc  FROM {course} c, {specialite} sp,{cycle} cy,{salle} sa, {programme} p,{inscription} i
WHERE p.idcourses = c.id AND p.idspecialite = sp.id AND i.idetudiant='".$USER->id."'
AND p.idcycle = cy.id AND i.idcycle=cy.id AND i.idspecialite=sp.id 
...
$sqlsad = "SELECT fullname,DATE_FORMAT(FROM_UNIXTIME(p.datecours),'%D %b %Y') as datec,heuredebutcours,heurefincours,numerosalle,MONTH(FROM_UNIXTIME(p.datecours)) AS mois,DAYOFWEEK(FROM_UNIXTIME(p.datecours)) AS dayc  FROM {course} c, {specialite} sp,{cycle} cy,{salle} sa, {programme} p,{inscription} i
WHERE p.idcourses = c.id AND p.idspecialite = sp.id AND i.idetudiant='".$USER->id."'
AND p.idcycle = cy.id AND i.idcycle=cy.id AND i.idspecialite=sp.id 
...
if($_GET["idsem"])
{
  ...
  $datefinveri=$val->datefinsemestre;
    $sqllu = "SELECT fullname,DATE_FORMAT(FROM_UNIXTIME(p.datecours),'%D %b %Y') as datec,heuredebutcours,heurefincours,numerosalle,MONTH(FROM_UNIXTIME(p.datecours)) AS mois,DAYOFWEEK(FROM_UNIXTIME(p.datecours)) AS dayc  FROM {course} c, {specialite} sp,{cycle} cy,{salle} sa, {programme} p,{inscription} i
    WHERE p.idcourses = c.id  AND p.idspecialite = sp.id AND i.idetudiant='".$USER->id."'
    AND p.idcycle = cy.id AND i.idcycle=cy.id AND i.idspecialite=sp.id AND datecours BETWEEN $datedebutveri AND $datefinveri
    AND sa.id=p.idsalle AND DAYOFWEEK(FROM_UNIXTIME(p.datecours))=2 GROUP BY fullname,heuredebutcours,heurefincours,dayc";
...
{
  $sqlluno = "SELECT fullname,DATE_FORMAT(FROM_UNIXTIME(p.datecours),'%D %b %Y') as datec,heuredebutcours,heurefincours,numerosalle,MONTH(FROM_UNIXTIME(p.datecours)) AS mois,DAYOFWEEK(FROM_UNIXTIME(p.datecours)) AS dayc  FROM {course} c, {specialite} sp,{cycle} cy,{salle} sa, {programme} p,{inscription} i
  WHERE p.idcourses = c.id  AND p.idspecialite = sp.id AND i.idetudiant='".$USER->id."'
  AND p.idcycle = cy.id AND i.idcycle=cy.id AND i.idspecialite=sp.id 
            ...
            <div class="modal-content">
              ...
              <div class="modal-body">
                ...
                foreach ($lundino as $key => $valuemar){
                  $valuool='<span style="font-weight:700">'.date("d/m/Y",$valuemar->datecours).'<br>';
...
{
    $sqlmano = "SELECT fullname,DATE_FORMAT(FROM_UNIXTIME(p.datecours),'%D %b %Y') as datec,heuredebutcours,heurefincours,numerosalle,MONTH(FROM_UNIXTIME(p.datecours)) AS mois,DAYOFWEEK(FROM_UNIXTIME(p.datecours)) AS dayc ,datecours FROM {course} c, {specialite} sp,{cycle} cy,{salle} sa, {programme} p,{inscription} i
  WHERE p.idcourses = c.id AND p.idspecialite = sp.id AND i.idetudiant='".$USER->id."'
  AND p.idcycle = cy.id AND i.idcycle=cy.id AND i.idspecialite=sp.id 
...
{
  $sqlmeno = "SELECT fullname,DATE_FORMAT(FROM_UNIXTIME(p.datecours),'%D %b %Y') as datec,heuredebutcours,heurefincours,numerosalle,MONTH(FROM_UNIXTIME(p.datecours)) AS mois,DAYOFWEEK(FROM_UNIXTIME(p.datecours)) AS dayc ,datecours FROM {course} c, {specialite} sp,{cycle} cy,{salle} sa, {programme} p,{inscription} i
  WHERE p.idcourses = c.id AND p.idspecialite = sp.id AND i.idetudiant='".$USER->id."'
  AND p.idcycle = cy.id AND i.idcycle=cy.id AND i.idspecialite=sp.id 
      ...
      <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
          ...
          foreach ($mercredino as $key => $valuemar){
            $valuoomer='<span style="font-weight:700">'.date("l d F Y",$valuemar->datecours).'</span><br>';
...
{
  $sqljeuno = "SELECT fullname,DATE_FORMAT(FROM_UNIXTIME(p.datecours),'%D %b %Y') as datec,heuredebutcours,heurefincours,numerosalle,MONTH(FROM_UNIXTIME(p.datecours)) AS mois,DAYOFWEEK(FROM_UNIXTIME(p.datecours)) AS dayc,datecours  FROM {course} c, {specialite} sp,{cycle} cy,{salle} sa, {programme} p,{inscription} i
  WHERE p.idcourses = c.id AND p.idspecialite = sp.id AND i.idetudiant='".$USER->id."'
  AND p.idcycle = cy.id AND i.idcycle=cy.id AND i.idspecialite=sp.id 
...
{
  $sqlvenno = "SELECT fullname,DATE_FORMAT(FROM_UNIXTIME(p.datecours),'%D %b %Y') as datec,heuredebutcours,heurefincours,numerosalle,MONTH(FROM_UNIXTIME(p.datecours)) AS mois,DAYOFWEEK(FROM_UNIXTIME(p.datecours)) AS dayc,datecours  FROM {course} c, {specialite} sp,{cycle} cy,{salle} sa, {programme} p,{inscription} i
  WHERE p.idcourses = c.id AND p.idspecialite = sp.id AND i.idetudiant='".$USER->id."'
  AND p.idcycle = cy.id AND i.idcycle=cy.id AND i.idspecialite=sp.id 
    ...
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
        ...
        foreach ($vendredino as $key => $valueven){
          $valuooven='<span style="font-weight:700">'.date("l d F Y",$valuemar->datecours).'</span><br>';
...
{
  $sqlsadno = "SELECT fullname,DATE_FORMAT(FROM_UNIXTIME(p.datecours),'%D %b %Y') as datec,heuredebutcours,heurefincours,numerosalle,MONTH(FROM_UNIXTIME(p.datecours)) AS mois,DAYOFWEEK(FROM_UNIXTIME(p.datecours)) AS dayc  FROM {course} c, {specialite} sp,{cycle} cy,{salle} sa, {programme} p,{inscription} i
  WHERE p.idcourses = c.id AND p.idspecialite = sp.id AND i.idetudiant='".$USER->id."'
  AND p.idcycle = cy.id AND i.idcycle=cy.id AND i.idspecialite=sp.id 
