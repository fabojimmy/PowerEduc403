...
WHERE p.idcourses = c.id  AND p.idspecialite = sp.id AND p.idprof='".$USER->id."'
AND p.idcycle = cy.id  AND sa.id=p.idsalle AND DAYOFWEEK(FROM_UNIXTIME(p.datecours))=2 GROUP BY fullname,heuredebutcours,heurefincours,dayc";
...
WHERE p.idcourses = c.id  AND p.idspecialite = sp.id AND p.idprof='".$USER->id."'
AND p.idcycle = cy.id  AND sa.id=p.idsalle AND DAYOFWEEK(FROM_UNIXTIME(p.datecours))=3 GROUP BY fullname,heuredebutcours,heurefincours,dayc";
...
WHERE p.idcourses = c.id  AND p.idspecialite = sp.id AND p.idprof='".$USER->id."'
AND p.idcycle = cy.id  AND sa.id=p.idsalle AND DAYOFWEEK(FROM_UNIXTIME(p.datecours))=4 GROUP BY fullname,heuredebutcours,heurefincours,dayc";
...
WHERE p.idcourses = c.id  AND p.idspecialite = sp.id AND p.idprof='".$USER->id."'
AND p.idcycle = cy.id  AND sa.id=p.idsalle AND DAYOFWEEK(FROM_UNIXTIME(p.datecours))=5 GROUP BY fullname,heuredebutcours,heurefincours,dayc";
...
WHERE p.idcourses = c.id  AND p.idspecialite = sp.id AND p.idprof='".$USER->id."'
AND p.idcycle = cy.id  AND sa.id=p.idsalle AND DAYOFWEEK(FROM_UNIXTIME(p.datecours))=6 GROUP BY fullname,heuredebutcours,heurefincours,dayc";
...
WHERE p.idcourses = c.id  AND p.idspecialite = sp.id AND p.idprof='".$USER->id."'
AND p.idcycle = cy.id  AND sa.id=p.idsalle AND DAYOFWEEK(FROM_UNIXTIME(p.datecours))=7 GROUP BY fullname,heuredebutcours,heurefincours,dayc";
...
if(!empty($_GET["idsem"]))
{
    ...
    $sqllu = "SELECT fullname,DATE_FORMAT(FROM_UNIXTIME(p.datecours),'%D %b %Y') as datec,heuredebutcours,heurefincours,numerosalle,MONTH(FROM_UNIXTIME(p.datecours)) AS mois,DAYOFWEEK(FROM_UNIXTIME(p.datecours)) AS dayc,datecours  FROM {course} c, {specialite} sp,{cycle} cy,{salle} sa, {programme} p
    WHERE p.idcourses = c.id  AND p.idspecialite = sp.id AND p.idprof='".$USER->id."' AND datecours BETWEEN $datedebutveri AND $datefinveri
    AND p.idcycle = cy.id  AND sa.id=p.idsalle AND DAYOFWEEK(FROM_UNIXTIME(p.datecours))=2 GROUP BY fullname,heuredebutcours,heurefincours,dayc";

    $lundi=$DB->get_recordset_sql($sqllu);
    $sqlma = "SELECT fullname,DATE_FORMAT(FROM_UNIXTIME(p.datecours),'%D %b %Y') as datec,heuredebutcours,heurefincours,numerosalle,MONTH(FROM_UNIXTIME(p.datecours)) AS mois,DAYOFWEEK(FROM_UNIXTIME(p.datecours)) AS dayc,datecours  FROM {course} c, {specialite} sp,{cycle} cy,{salle} sa, {programme} p
    WHERE p.idcourses = c.id  AND p.idspecialite = sp.id AND p.idprof='".$USER->id."' AND datecours BETWEEN $datedebutveri AND $datefinveri
    AND p.idcycle = cy.id  AND sa.id=p.idsalle AND DAYOFWEEK(FROM_UNIXTIME(p.datecours))=3 GROUP BY fullname,heuredebutcours,heurefincours,dayc";

    $mardi=$DB->get_recordset_sql($sqlma);
    $sqlme = "SELECT fullname,DATE_FORMAT(FROM_UNIXTIME(p.datecours),'%D %b %Y') as datec,heuredebutcours,heurefincours,numerosalle,MONTH(FROM_UNIXTIME(p.datecours)) AS mois,DAYOFWEEK(FROM_UNIXTIME(p.datecours)) AS dayc,datecours  FROM {course} c, {specialite} sp,{cycle} cy,{salle} sa, {programme} p
    WHERE p.idcourses = c.id  AND p.idspecialite = sp.id AND p.idprof='".$USER->id."' AND datecours BETWEEN $datedebutveri AND $datefinveri
    AND p.idcycle = cy.id  AND sa.id=p.idsalle AND DAYOFWEEK(FROM_UNIXTIME(p.datecours))=4 GROUP BY fullname,heuredebutcours,heurefincours,dayc";

    $mercredi=$DB->get_recordset_sql($sqlme);
    $sqljeu = "SELECT fullname,DATE_FORMAT(FROM_UNIXTIME(p.datecours),'%D %b %Y') as datec,heuredebutcours,heurefincours,numerosalle,MONTH(FROM_UNIXTIME(p.datecours)) AS mois,DAYOFWEEK(FROM_UNIXTIME(p.datecours)) AS dayc,datecours  FROM {course} c, {specialite} sp,{cycle} cy,{salle} sa, {programme} p
    WHERE p.idcourses = c.id  AND p.idspecialite = sp.id AND p.idprof='".$USER->id."' AND datecours BETWEEN $datedebutveri AND $datefinveri
    AND p.idcycle = cy.id  AND sa.id=p.idsalle AND DAYOFWEEK(FROM_UNIXTIME(p.datecours))=5 GROUP BY fullname,heuredebutcours,heurefincours,dayc";

    $jeudi=$DB->get_recordset_sql($sqljeu);
    $sqlven = "SELECT fullname,DATE_FORMAT(FROM_UNIXTIME(p.datecours),'%D %b %Y') as datec,heuredebutcours,heurefincours,numerosalle,MONTH(FROM_UNIXTIME(p.datecours)) AS mois,DAYOFWEEK(FROM_UNIXTIME(p.datecours)) AS dayc,datecours  FROM {course} c, {specialite} sp,{cycle} cy,{salle} sa, {programme} p
    WHERE p.idcourses = c.id  AND p.idspecialite = sp.id AND p.idprof='".$USER->id."' AND datecours BETWEEN $datedebutveri AND $datefinveri
    AND p.idcycle = cy.id  AND sa.id=p.idsalle AND DAYOFWEEK(FROM_UNIXTIME(p.datecours))=6 GROUP BY fullname,heuredebutcours,heurefincours,dayc";

    $vendredi=$DB->get_recordset_sql($sqlven);
    $sqlsad = "SELECT fullname,DATE_FORMAT(FROM_UNIXTIME(p.datecours),'%D %b %Y') as datec,heuredebutcours,heurefincours,numerosalle,MONTH(FROM_UNIXTIME(p.datecours)) AS mois,DAYOFWEEK(FROM_UNIXTIME(p.datecours)) AS dayc,datecours  FROM {course} c, {specialite} sp,{cycle} cy,{salle} sa, {programme} p
    WHERE p.idcourses = c.id  AND p.idspecialite = sp.id AND p.idprof='".$USER->id."' AND datecours BETWEEN $datedebutveri AND $datefinveri
    AND p.idcycle = cy.id  AND sa.id=p.idsalle AND DAYOFWEEK(FROM_UNIXTIME(p.datecours))=7 GROUP BY fullname,heuredebutcours,heurefincours,dayc";
...
{
  $sqlluno = "SELECT fullname,DATE_FORMAT(FROM_UNIXTIME(p.datecours),'%D %b %Y') as datec,heuredebutcours,heurefincours,numerosalle,MONTH(FROM_UNIXTIME(p.datecours)) AS mois,DAYOFWEEK(FROM_UNIXTIME(p.datecours)) AS dayc,datecours  FROM {course} c, {specialite} sp,{cycle} cy,{salle} sa, {programme} p
  WHERE p.idcourses = c.id  AND p.idspecialite = sp.id AND p.idprof='".$USER->id."'
  AND p.idcycle = cy.id  AND sa.id=p.idsalle AND DAYOFWEEK(FROM_UNIXTIME(p.datecours))=2
...
{
    $sqlmano = "SELECT fullname,DATE_FORMAT(FROM_UNIXTIME(p.datecours),'%D %b %Y') as datec,heuredebutcours,heurefincours,numerosalle,MONTH(FROM_UNIXTIME(p.datecours)) AS mois,DAYOFWEEK(FROM_UNIXTIME(p.datecours)) AS dayc,datecours  FROM {course} c, {specialite} sp,{cycle} cy,{salle} sa, {programme} p
    WHERE p.idcourses = c.id  AND p.idspecialite = sp.id AND p.idprof='".$USER->id."'
    AND p.idcycle = cy.id  AND sa.id=p.idsalle AND DAYOFWEEK(FROM_UNIXTIME(p.datecours))=3
  AND fullname='".$valuel->fullname."' AND heuredebutcours='".$valuel->heuredebutcours."' AND heurefincours='".$valuel->heurefincours."'";
  $tarmard=array();
...
{
  $sqlmeno = "SELECT fullname,DATE_FORMAT(FROM_UNIXTIME(p.datecours),'%D %b %Y') as datec,heuredebutcours,heurefincours,numerosalle,MONTH(FROM_UNIXTIME(p.datecours)) AS mois,DAYOFWEEK(FROM_UNIXTIME(p.datecours)) AS dayc,datecours  FROM {course} c, {specialite} sp,{cycle} cy,{salle} sa, {programme} p
  WHERE p.idcourses = c.id  AND p.idspecialite = sp.id AND p.idprof='".$USER->id."'
  AND p.idcycle = cy.id  AND sa.id=p.idsalle AND DAYOFWEEK(FROM_UNIXTIME(p.datecours))=4
  AND fullname='".$valuel->fullname."' AND heuredebutcours='".$valuel->heuredebutcours."' AND heurefincours='".$valuel->heurefincours."'";
  $tarmer=array();
...
{
  $sqljeuno = "SELECT fullname,DATE_FORMAT(FROM_UNIXTIME(p.datecours),'%D %b %Y') as datec,heuredebutcours,heurefincours,numerosalle,MONTH(FROM_UNIXTIME(p.datecours)) AS mois,DAYOFWEEK(FROM_UNIXTIME(p.datecours)) AS dayc,datecours  FROM {course} c, {specialite} sp,{cycle} cy,{salle} sa, {programme} p
  WHERE p.idcourses = c.id  AND p.idspecialite = sp.id AND p.idprof='".$USER->id."'
  AND p.idcycle = cy.id  AND sa.id=p.idsalle AND DAYOFWEEK(FROM_UNIXTIME(p.datecours))=5 
  AND fullname='".$valuel->fullname."' AND heuredebutcours='".$valuel->heuredebutcours."' AND heurefincours='".$valuel->heurefincours."'";
...
{
  $sqlvenno = "SELECT fullname,DATE_FORMAT(FROM_UNIXTIME(p.datecours),'%D %b %Y') as datec,heuredebutcours,heurefincours,numerosalle,MONTH(FROM_UNIXTIME(p.datecours)) AS mois,DAYOFWEEK(FROM_UNIXTIME(p.datecours)) AS dayc,datecours  FROM {course} c, {specialite} sp,{cycle} cy,{salle} sa, {programme} p
  WHERE p.idcourses = c.id  AND p.idspecialite = sp.id AND p.idprof='".$USER->id."'
  AND p.idcycle = cy.id  AND sa.id=p.idsalle AND DAYOFWEEK(FROM_UNIXTIME(p.datecours))=6
  AND fullname='".$valuel->fullname."' AND heuredebutcours='".$valuel->heuredebutcours."' AND heurefincours='".$valuel->heurefincours."'";
...
{
  $sqlsadno = "SELECT fullname,DATE_FORMAT(FROM_UNIXTIME(p.datecours),'%D %b %Y') as datec,heuredebutcours,heurefincours,numerosalle,MONTH(FROM_UNIXTIME(p.datecours)) AS mois,DAYOFWEEK(FROM_UNIXTIME(p.datecours)) AS dayc,datecours  FROM {course} c, {specialite} sp,{cycle} cy,{salle} sa, {programme} p
  WHERE p.idcourses = c.id  AND p.idspecialite = sp.id AND p.idprof='".$USER->id."'
  AND p.idcycle = cy.id  AND sa.id=p.idsalle AND DAYOFWEEK(FROM_UNIXTIME(p.datecours))=7
  AND fullname='".$valuel->fullname."' AND heuredebutcours='".$valuel->heuredebutcours."' AND heurefincours='".$valuel->heurefincours."'";
...
$templatecontext=[
    ...
    "courssemestre"=>$CFG->wwwroot.'/local/powerschool/programmeprof.php'
];
echo $OUTPUT->header();
