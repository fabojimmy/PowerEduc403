...
$PAGE->set_heading('Exportation des données');

$PAGE->navbar->add(get_string('reglages', 'local_powerschool'), $CFG->wwwroot.'/local/powerschool/reglages.php');
$PAGE->navbar->add(get_string('exportation', 'local_powerschool'), $managementurl);
...
$templatecontext = (object)[
    ...
    'exportatioon'=> new moodle_url('/local/powerschool/exportation.php'),
...
echo $OUTPUT->render_from_template('local_powerschool/exportation', $templatecontext);
